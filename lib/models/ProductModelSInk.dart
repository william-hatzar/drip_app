...
String jordan1Description =
    "Play like '85.The Air Jordan 1 Mid SE brings fresh details and premium comfort to an iconic shoe.Its encapsulated Air-Sole unit cushions your foot, while the padded collar gives you a supportive feel on the move.";
String jordan5Description =
...
String kawsBlackJumper =
    "This KAWS x UNIQLO UT Graphic Sweatshirt 'Black' features a depiction of KAWS' cherished COMPANION character, depicting a father and son. On the back, you'll discover the iconic XX design that is synonymous with KAWS' artwork.";
String brokenPlanetDesc =
    "The Broken Planet Market 'Into the Abyss' Hoodie in Navy is a must-have addition to your wardrobe, offering both style and comfort. Crafted with premium materials and attention to detail, this hoodie is perfect for those who appreciate quality streetwear.";
String noctaDesc =
    "SPECIAL COLLECTION CELEBRATING 10 YEARS OF TECH FLEECE.DOUBLE LAYERED HOOD, RIBBED HEM FINISHES, ARTICULATED SLEEVES. SIGNATURE NOCTA BRANDING, CUSTOM MOLDED 2-WAY METAL ZIPPER + PULLER.  53% COTTON. 47% POLYESTER."
        .toLowerCase();
String supremeDesc =
    "The Supreme Corteiz Rules The World Tee Black is a stylish and comfortable t-shirt that is perfect for any casual occasion. This t-shirt is part of the Supreme/Corteiz collaboration and features a printed graphic on the front and back. The graphic on the front reads \"\ Supreme Rules The World, which is a playful nod to Corteiz’s usual tagline Corteiz Rules The World\"\ ";
